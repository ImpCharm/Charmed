...
client_id = '1238632176413573261' # id of your Discord application
large_text = "charmedicon" # text of large img of your app
large_image = "charmedicon" # large img of your app
small_text = "charmedicon" # text of small img of your app
small_image = "charmedicon" # small img of your app
