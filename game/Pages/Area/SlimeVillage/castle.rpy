label slimevillage_castle:
    ...
    if(game.objective[2].completionFlags[2] == True
        ...
        and slimecastlemonologue == False):
            call cutscene_slimeprincess_castle_1 from _call_cutscene_slimeprincess_castle_1
    ...
    menu slimevillage_castle_menu:
        "Talk to [slimePrincess.profile.name]":
            ...
            menu:
                "Fight her":
                    call enterCombat(slimePrincess) from _call_enterCombat_5
                ...
                "Submit":
                    ...
                    call fight_slimeprincess_victory_submit from _call_fight_slimeprincess_victory_submit
